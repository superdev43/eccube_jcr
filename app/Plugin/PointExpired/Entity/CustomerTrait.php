...
trait CustomerTrait
{
     ...
     * @var \DateTime|null
     *
     * @ORM\Column(name="point_expired_date", type="datetimetz", nullable=true)
     */
    private $point_expired_date;
    ...
    public function setPointExpiredDate($date)
    {
        $this->point_expired_date = $date;

        return $this;
    }

    public function getPointExpiredDate()
    {
        return $this->point_expired_date;
    }
